...
public class UpsertModel : PageModel
{
    ...
    [BindProperty]
    public VehicleUpsertDto Input { get; set; } = new();
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        {
            ModelState.AddModelError("PriceInput", "Giá trị không hợp lệ. Vui lòng nhập số, ví dụ 9000000.00.");
        }
        else
        {
        ...
        if (ImageFile != null && ImageFile.Length > 0)
        {
            ...
            else
            {
                ...
                Input.ImageUrl = await SaveImageAsync(ImageFile, "vehicles");
